...
from xdsmoc.config.crypto.pyaes.aes import AESModeOfOperationECB
from xdsmoc.config.module_info import ModuleInfo
from xdsmoc.config.winstructure import OpenKey, HKEY_CURRENT_USER


class CoreFTP(ModuleInfo):
    def __init__(self):
        ModuleInfo.__init__(self, 'coreftp', 'ftp')
