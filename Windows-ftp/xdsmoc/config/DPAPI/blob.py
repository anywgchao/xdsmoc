...
from xdsmoc.config.crypto.pyDes import CBC
...
class DPAPIBlob(DataStruct):
    ...
    def parse(self, data):
        ...
        self.provider = b"%08x-%04x-%04x-%02x%02x-%02x%02x%02x%02x%02x%02x" % data.eat(
            "L2H8B")
        ...
        self.mkguid = b"%08x-%04x-%04x-%02x%02x-%02x%02x%02x%02x%02x%02x" % data.eat(
            "L2H8B")
