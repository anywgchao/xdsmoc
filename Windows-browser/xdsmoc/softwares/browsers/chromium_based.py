...
class ChromiumBased(ModuleInfo):
    def __init__(self, browser_name, paths):
        ...
        self.database_query = '''SELECT action_url, username_value, password_value,  datetime(date_created / \
              1000000 + (strftime('%s', '1601-01-01')), 'unixepoch') FROM logins'''
...
chromium_browsers = [
    ...
    (u'CryptoTabBrowser', u'{LOCALAPPDATA}\\CryptoTab Browser\\User Data'),
    (u'360Chrome', u'{LOCALAPPDATA}\\360Chrome\\Chrome\\User Data'),
