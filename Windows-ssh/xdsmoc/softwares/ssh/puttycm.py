'''
@Author: Daboluo
@Date: 2018-10-08 18:10:07
@LastEditTime: 2020-06-11 10:59:40
...
from xdsmoc.config.winstructure import (HKEY_CURRENT_USER, OpenKey,
                                        string_to_unicode)


class Puttycm(ModuleInfo):
    def __init__(self):
        ModuleInfo.__init__(self, 'puttycm', 'ssh', registry_used=True)
