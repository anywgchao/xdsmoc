...
if __name__ == '__main__':
    key = "q3iV3wBRsyqomVCA"
    aescryptor = Aescrypt(key, AES.MODE_CBC)
    text = b"hello worldsdfdsfdsfdsfdsfdsfdsfdsfdsfds"
    en_text = aescryptor.aesencrypt(text)
    print("cipher:", en_text)
    # text = aescryptor.aesdecrypt(en_text)
    # print("text:", text)
    # aescryptor.encrypt_file('c://hello.txt')
    # aescryptor.decrypt_file('c://encrypt_hello.txt')
"""