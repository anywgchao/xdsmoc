...
class VaultPolicy(DataStruct):
    ...
    def parse(self, data):
        ...
        self.size = data.eat("L")
        # data.eat("16s")
        self.unknown4 = b"%0x-%0x-%0x-%0x%0x-%0x%0x%0x%0x%0x%0x" % data.eat(
            "L2H8B")
        # data.eat("16s")
        self.unknown5 = b"%0x-%0x-%0x-%0x%0x-%0x%0x%0x%0x%0x%0x" % data.eat(
            "L2H8B")
        # DPAPI_BLOB_STORE
...
class VaultVcrd(DataStruct):
    ...
    def parse(self, data):
        # data.eat("16s")
        self.schema_guid = b"%0x-%0x-%0x-%0x%0x-%0x%0x%0x%0x%0x%0x" % data.eat(
            "L2H8B")
...
class VaultVsch(DataStruct):
    ...
    def parse(self, data):
        ...
        self.schema_name = data.eat_length_and_string(
            "L").replace(b"\x00", b"")
...
class VaultSchemaPin(DataStruct):
    ...
    def parse(self, data):
        ...
        self.authenticator = data.eat_length_and_string(
            "L").replace(b"\x00", b"")  # Password
...
class VaultSchemaActiveSync(DataStruct):
    ...
    def parse(self, data):
        ...
        self.resource = data.eat_length_and_string("L").replace(b"\x00", b"")
        self.id_authenticator = data.eat("L")
        self.authenticator = codecs.encode(
            data.eat_length_and_string("L").replace(b"\x00", b""), 'hex')
